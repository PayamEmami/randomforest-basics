...
3. Fit a random forest model to the training data and find its accuracy (either out of bag error or cross validation. up to you!)
4. FInd the accuracy of predictiing the test set
